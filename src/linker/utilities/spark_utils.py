...
def build_cluster(
    ...
    Args:
        ...
        input_bindings: Bindings for input files.
...
def build_cluster_launch_script(
    results_dir: Path, diagnostics_dir: Path, input_bindings: Dict[str, str]
) -> TextIO:
    ...
    for outside_path, inside_path in input_bindings.items():
        worker_bindings += f"--bind {outside_path}:{inside_path} "
