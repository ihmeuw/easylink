...
from easylink.utilities.data_utils import download_image, load_yaml
...
class Implementation:
    ...
    def validate(self, skip_image_validation: bool, images_dir: str | Path) -> list[str]:
        ...
        if not skip_image_validation:
            logs = self._validate_image_exists(logs, images_dir)
        return logs
    ...
    def _validate_image_exists(self, logs: list[str], images_dir: str | Path) -> list[str]:
