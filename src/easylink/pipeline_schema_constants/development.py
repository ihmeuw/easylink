...
NODES = [
    ...
    LoopStep(
        ...
        slot_mappings={
            "input": [SlotMapping("input", "step_3", "step_3_main_output", "step_3", "step_3_main_input")],
            "output": [SlotMapping("output", "step_3", "step_3_main_output", "step_3", "step_3_main_input")],
        }
    ),
    BasicStep(
        "step_4",
